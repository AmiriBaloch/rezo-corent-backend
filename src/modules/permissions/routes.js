 ...
 * @access Admin only
 */
router.post("/", authMiddleware(["admin"]), validatePermission, (req, res, next) =>
 ...
 */
router.get("/", authMiddleware(), (req, res, next) => PermissionController.listPermissions(req, res, next));
 ...
 * @access Admin & authorized users
 */
router.get("/:id", authMiddleware(), (req, res, next) => PermissionController.getPermission(req, res, next));
 ...
 * @access Admin only
 */
router.patch("/:id", authMiddleware(["admin"]), validatePermission, (req, res, next) =>
 ...
 * @access Admin only
 */
router.delete("/:id", authMiddleware(["admin"]), (req, res, next) => PermissionController.deletePermission(req, res, next));
